    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="menu_assistente.php?logout=ok"><span class="glyphicon glyphicon-off"></span>Sair</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <!-- /.navbar-collapse -->
			...
			<div>
				<ul class="breadcrumb">
					<li>
				   <a href="listaassistente.php"><span class="glyphicon glyphicon-tasks"></span>Lista de Assistente</a></li>
				   <a href="assistente.php"><span class="glyphicon glyphicon-plus"></span>Novo Assistente</a></li>	
				</ul>
			</div>
