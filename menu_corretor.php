    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="menu_corretor.php?logout=ok"><span class="glyphicon glyphicon-off"></span>Sair</a></li>
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <!-- /.navbar-collapse -->
			...
			<div>
				<ul class="breadcrumb">
					<li>
				   <a href="listacorretor.php"><span class="glyphicon glyphicon-tasks"></span>Lista de Corretores</a></li><span class="divider">/</span>
                                   <a href="cadastrocorretor.php"><span class="glyphicon glyphicon-plus-sign green"></span>Novo Corretor</a></li><span class="divider">/</span>
                                   <a href="comissoes.php"><span class="glyphicon glyphicon-euro"></span>Comissões</a></li><span class="divider">/</span>	
